  ...
  return (
    <div className='group/feature text-foreground flex flex-col gap-4 p-4'>
      ...
      <div className='flex items-center self-start'>
        <div className='flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-primary/20 to-primary/10 shadow-inner ring-1 ring-primary/20 transition-all duration-300 group-hover/feature:scale-110 group-hover/feature:ring-primary/40'>
          {icon}
        </div>
      </div>
      {/* Title */}
